...
def evaluate_model(env_name, model_path, seed=0, n_episodes=1000):
    ...
    for _ in range(n_episodes):
        ...
        while not done:
            ...
            action = np.linspace(-2.0, 2.0, action_size)[action_index]
...
model_paths = [
    'models/dqn_lr_0.0005_gamma_0.99_tau_0.001_seed_0_pendulum.pth',
    'models/dqn_lr_0.0005_gamma_0.99_tau_0.001_seed_1_pendulum.pth',
    'models/dqn_lr_0.0005_gamma_0.99_tau_0.001_seed_2_pendulum.pth',
    'models/dqn_lr_0.0005_gamma_0.95_tau_0.01_seed_0_pendulum.pth',
    'models/dqn_lr_0.0005_gamma_0.95_tau_0.01_seed_1_pendulum.pth',
    'models/dqn_lr_0.0005_gamma_0.95_tau_0.01_seed_2_pendulum.pth'
]
...
ax.set_title('Model Evaluation on Pendulum-v1')
