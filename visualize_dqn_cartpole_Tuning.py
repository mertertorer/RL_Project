...
# Visualize the agent
hyperparams = ["lr_0.001_gamma_0.99_tau_0.001", "lr_0.0005_gamma_0.95_tau_0.01"]
for params in hyperparams:
    model_path = f'models/dqn_cartpole_{params}.pth'
    print(f"Visualizing model with hyperparameters: {params}")
    visualize_agent(env, agent, model_path)
